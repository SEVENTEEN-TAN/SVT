...
public class MenuInfo implements Serializable {
    ...
    @Column(value = "menu_name_zh", comment = "菜单中文名称")
    private String menuNameZh;

    @Column(value = "menu_name_en", comment = "菜单英文名称")
    private String menuNameEn;

    @Column(value = "menu_path", comment = "菜单路径")
