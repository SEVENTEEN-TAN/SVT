...
@Table(value = "permission_info", comment = "权限表",
...
public class PermissionInfo implements Serializable {
    ...
    @Column(value = "permission_key", comment = "权限标识")
    private String permissionKey;

    @Column(value = "permission_name_zh", comment = "权限中文名称")
    private String permissionNameZh;

    @Column(value = "permission_name_en", comment = "权限英文名称")
    private String permissionNameEn;

    @Column(value = "permission_group", comment = "权限分组（如：system, business等）")
