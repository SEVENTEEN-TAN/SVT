...
┌─────────────────────────────────────────────────────────┐
│                  应用服务层 (Backend)                    │
│         Spring Boot 3.3.2 + Java 21 + MyBatis-Flex      │
└─────────────────────────────────────────────────────────┘
                            │
┌─────────────────────────────────────────────────────────┐
│                   数据持久层 (Database)                  │
...
| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **Spring Boot** | 3.3.2 | 应用框架 | 企业级Java应用框架，提供自动配置和快速开发能力 |
...
| 技术 | 版本 | 用途 | 说明 |
|------|------|------|------|
| **Spring Security** | 6.x (Spring Boot 3.3.2内置) | 安全框架 | 认证和授权框架 |
...
| **Spring Boot Test** | 3.3.2 | 集成测试 | Spring Boot测试支持 |
