...
**接口地址**:`/api/system/menu/edit-menu`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|editMenuDTO|EditMenuDTO|body|true|EditMenuDTO|EditMenuDTO|
...
**接口地址**:`/api/system/menu/get-menu-detail`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|getMenuDetailDTO|GetMenuDetailDTO|body|true|GetMenuDetailDTO|GetMenuDetailDTO|
...
**接口地址**:`/api/system/menu/delete-menu`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|deleteMenuDTO|DeleteMenuDTO|body|true|DeleteMenuDTO|DeleteMenuDTO|
|&emsp;&emsp;menuId|菜单ID||true|string||
